...
/*
 * Return a short human-readable IRQ purpose for debug output. The common IRQ
 * core intentionally does not own platform naming because IRQ numbers are
 * translated from architecture-specific domains such as ARM64 GIC INTIDs.
 */
